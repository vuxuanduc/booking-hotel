...
@section('content')
    ...
    <div class="height-100">
        ...
        <form id="create-status-admin" action="{{ route('statuses.store') }}" method="post">
            @csrf
            <div class="form-group" style="padding-right: 30px;">
                ...
                <input type="text" class="form-control mt-2" id="name_status" placeholder="Tên trạng thái..." name="name_status">
            </div>
            <button type="submit" class="btn text-white fw-bold mt-3" style="background-color: #86B817;">Thêm trạng thái</button>
        </form>
    </div>
@endsection
...
@section('script')
    ...
    <script>
        $(document).ready(function(){
            $('#create-status-admin').on('submit' , function(event){
