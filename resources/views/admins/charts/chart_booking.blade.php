    ...
    <div class="height-100">
        ...
        <div class="chart-wrapper">
            <div class="form-chart row mt-2">
                ...
                <div class="col-8">
                    <form action="{{ route('post-chart-bookings') }}" method="post" id="revenue" class="px-2">
        ...
        <div class="mt-4 mx-4 d-flex justify-content-end">  
            <a href="{{ route('chart-revenue') }}" class="btn btn-primary">Thống kê doanh thu</a>
        </div>
    </div>
@endsection
...
@section('script')
    ...
    <script>
        new Morris.Bar({
            ...
            data: [
                @foreach($resultBookings as $keyBooking => $valueBooking)
                    { Name: '{{ $valueBooking->name_hotel }}', value: {{ $valueBooking->total_bookings }} },
                @endforeach
            ],
