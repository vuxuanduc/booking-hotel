...
@section('content')
    ...
    <div class="height-100">
        ...
        <form id="create-room-type-admin" action="{{ route('room-types.store') }}" method="post">
            @csrf
            <div class="form-group" style="padding-right: 30px;">
                ...
                <input type="text" class="form-control mt-2" id="room_type_name" placeholder="Tên loại phòng..." name="room_type_name">
            </div>
            <button type="submit" class="btn text-white fw-bold mt-3" style="background-color: #86B817;">Thêm loại phòng</button>
        </form>
    </div>
@endsection
...
@section('script')
    ...
    <script>
        $(document).ready(function(){
            $('#create-room-type-admin').on('submit' , function(event){
